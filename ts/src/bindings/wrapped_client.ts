...
export const networks = {
  testnet: {
    ...
    contractId: "CAZVMBFXV5BND47QLUKIZ5ZEEM4S5STZ7WRJRG7O5IFPR766EOUAJD6L",
  }
} as const

export type Metadatakey = {tag: "WrapperMetadada", values: void};
...
export interface WrappedClient {
  /**
   * Construct and simulate a activate_wrapper transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  activate_wrapper: (options?: {
    /**
  ...
  /**
   * Construct and simulate a deactivate_wrapper transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  deactivate_wrapper: (options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  get_metadata: (options?: {
     ...
     */
    simulate?: boolean;
  }) => Promise<AssembledTransaction<WrapperMetadata>>

  /**
   * Construct and simulate a is_wrapper_active transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  is_wrapper_active: (options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  initialize: ({admin, asset, asset_controller}: {admin: string, asset: string, asset_controller: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class WrappedClient extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAQYWN0aXZhdGVfd3JhcHBlcgAAAAAAAAAA",
  ...
  public readonly fromJSON = {
    activate_wrapper: this.txFromJSON<null>,
        deactivate_wrapper: this.txFromJSON<null>,
        set_admin: this.txFromJSON<null>,
        set_authorized: this.txFromJSON<null>,
        get_metadata: this.txFromJSON<WrapperMetadata>,
        is_wrapper_active: this.txFromJSON<boolean>,
